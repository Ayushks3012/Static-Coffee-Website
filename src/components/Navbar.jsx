...
return (
  <nav
    className="relative bg-cover bg-center shadow-xl border-4 border-dashed 
    border-amber-500 rounded-xl overflow-hidden"
  >
    {/* Coffee Theme BG */}
    ...
    <div className="relative max-w-7xl mx-auto px-4 py-5">
      <div className="flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-5 items-center">
          ...
          <a
            href="#login"
            className="px-4 py-2 md:px-6 md:py-1 lg:py-3 border-2 border-yellow-400 text-yellow-400 rounded-full hover:bg-yellow-400 hover:text-white transition-all duration-300 font-bold text-sm md:text-sm"
            style={{ fontFamily: "'Montserrat,sans-serif" }}
          >
        ...
        <div className="md:hidden flex items-center">
          ...
          className="hover:text-yellow-300 transition-all duration-300 text-2xl p-2">
            {isOpen ? 
      ...
      (<div className='md:hidden bg-[#4B3621] bg-opacity-95 backdrop-blur-sm rounded-lg mt-4 py-4 shadow-xl'>
        <div className='flex flex-col space-y-4 px-4'>
          ...
          <div className='flex flex-col space-y-3 mt-4'>
            <a href="#order" className='w-full text-center py-3 bg-gradient-to-r from-yellow-400 to-yellow-600 text-white rounded-full shadow-md hover:shadow-lg hover:scale-105 hover:bg-gradient-to-l hover:from-yellow-600 hover:to-yellow-400 transition-all duration-300'>
              Order Now
            </a>
            <a href="#login" className='w-full text-center py-3 border-2 border-yellow-300 text-white rounded-full hover:bg-yellow-400 hover:text-white transition-all duration-300'>
              Login
            </a>
          </div>
        </div>
